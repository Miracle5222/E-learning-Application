            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $addquerry = "insert into tblquestions(description,time,level,quiz_Id,question_type) values ('$description','$time','$level','$quiz_Id','$question_type')";
                        ...
                        <?php
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong> Failed to add Questions</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                    <?php }
                    }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center flex-row ">
                                                    ...
                                                    <a href="editQuestions.php?question_Id=<?= $row['question_Id'] ?>&quiz_Id=<?= $row['quiz_Id'] ?>" class="mx-2 btn btn-info">Edit</a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <input type="text" class="form-control" required name="modules_Id" placeholder="Chicken curry..">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control without_ampm" required placeholder="23sec" name="time">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" required name="quiz_Id" value="<?= $_GET['quiz_Id'] ?>" placeholder="module name">
                                            </div>
