            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if (isset($_POST['editLessons'])) {
                        ...
                        $addquerry = "update tbllessons set lesson_name ='$lessonname' ,status = '$status' ,modules_Id ='$moduleId',lessons = '$lessonNo' where lesson_Id = '$_GET[lesson_Id]'";
                        $iquery = mysqli_query($conn, $addquerry);

                        if ($iquery) { ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Success!</strong> Lesson updated successfully.
                        ...
                        <?php
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong> Failed to update Lesson</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                    <?php }
                    }
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_GET['lesson_Id'])) {
                                        ...
                                        $selectQ = "select * from tbllessons where lesson_Id = '$_GET[lesson_Id]'";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="lesson name..." class="form-control my-2" value="<?= $row['lesson_name'] ?>" name="lessonname" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="12" class="form-control my-2" name="moduleId" value="<?= $row['modules_Id'] ?>" />

                                        </div>

                                        <div class="form-group">
                                            <label for="title">Lesson No.</label>
                                            <input type="text" placeholder="1.2" class="form-control my-2" value="<?= $row['lessons'] ?>" name="lessonNo" />

                                        </div>

                                        <div class="text-center">
                                            <button type="submit" name="editLessons" class="btn btn-primary my-2">Update</button>
                                        </div>
