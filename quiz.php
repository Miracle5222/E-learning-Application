                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center flex-row ">
                                                    ...
                                                    <a onclick="confirm('are you sure you want to delete this quiz?')" href="./process/deleteRecipe.php?recipe_id=<?= $row['recipe_id'] ?>" class="mx-2   btn btn-danger text-white">Delete</a>
