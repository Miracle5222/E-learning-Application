...
(781, 29, 168, 'done', 18),
(782, 29, 169, 'done', 18),
(783, 29, 170, 'unlock', 18),
(784, 29, 171, 'unlock', 19),
(785, 29, 172, 'lock', 19),
(786, 29, 173, 'lock', 19),
(787, 29, 174, 'lock', 19),
(788, 29, 175, 'lock', 19),
(789, 29, 176, 'lock', 19),
(790, 29, 177, 'unlock', 20),
(791, 29, 178, 'lock', 20),
(792, 29, 179, 'lock', 20),
(793, 29, 180, 'lock', 20),
(794, 29, 181, 'lock', 20),
...
(914, 32, 169, 'done', 18),
(915, 32, 170, 'done', 18),
(916, 32, 171, 'unlock', 19),
(917, 32, 172, 'lock', 19),
(918, 32, 173, 'lock', 19),
(919, 32, 174, 'lock', 19),
(920, 32, 175, 'lock', 19),
(921, 32, 176, 'lock', 19),
(922, 32, 177, 'unlock', 20),
(923, 32, 178, 'lock', 20),
(924, 32, 179, 'lock', 20),
(925, 32, 180, 'lock', 20),
(926, 32, 181, 'lock', 20),
...
(949, 33, 160, 'done', 17),
(950, 33, 161, 'done', 17),
(951, 33, 162, 'unlock', 17),
(952, 33, 163, 'unlock', 18),
(953, 33, 164, 'lock', 18),
(954, 33, 165, 'lock', 18),
(955, 33, 166, 'lock', 18),
(956, 33, 167, 'lock', 18),
...
(958, 33, 169, 'lock', 18),
(959, 33, 170, 'lock', 18),
(960, 33, 171, 'unlock', 19),
(961, 33, 172, 'lock', 19),
(962, 33, 173, 'lock', 19),
(963, 33, 174, 'lock', 19),
(964, 33, 175, 'lock', 19),
(965, 33, 176, 'lock', 19),
(966, 33, 177, 'unlock', 20),
(967, 33, 178, 'lock', 20),
(968, 33, 179, 'lock', 20),
(969, 33, 180, 'lock', 20),
(970, 33, 181, 'lock', 20),
...
(993, 34, 160, 'done', 17),
(994, 34, 161, 'done', 17),
(995, 34, 162, 'unlock', 17),
(996, 34, 163, 'unlock', 18),
(997, 34, 164, 'lock', 18),
(998, 34, 165, 'lock', 18),
(999, 34, 166, 'lock', 18),
(1000, 34, 167, 'lock', 18),
...
(1002, 34, 169, 'lock', 18),
(1003, 34, 170, 'lock', 18),
(1004, 34, 171, 'unlock', 19),
(1005, 34, 172, 'lock', 19),
(1006, 34, 173, 'lock', 19),
(1007, 34, 174, 'lock', 19),
(1008, 34, 175, 'lock', 19),
(1009, 34, 176, 'lock', 19),
(1010, 34, 177, 'unlock', 20),
(1011, 34, 178, 'lock', 20),
(1012, 34, 179, 'lock', 20),
(1013, 34, 180, 'lock', 20),
(1014, 34, 181, 'lock', 20),
...
(1037, 35, 160, 'done', 17),
(1038, 35, 161, 'done', 17),
(1039, 35, 162, 'unlock', 17),
(1040, 35, 163, 'unlock', 18),
(1041, 35, 164, 'lock', 18),
(1042, 35, 165, 'lock', 18),
(1043, 35, 166, 'lock', 18),
(1044, 35, 167, 'lock', 18),
...
(1046, 35, 169, 'lock', 18),
(1047, 35, 170, 'lock', 18),
(1048, 35, 171, 'unlock', 19),
(1049, 35, 172, 'lock', 19),
(1050, 35, 173, 'lock', 19),
(1051, 35, 174, 'lock', 19),
(1052, 35, 175, 'lock', 19),
(1053, 35, 176, 'lock', 19),
(1054, 35, 177, 'unlock', 20),
(1055, 35, 178, 'lock', 20),
(1056, 35, 179, 'lock', 20),
(1057, 35, 180, 'lock', 20),
(1058, 35, 181, 'lock', 20),
...
(44, 'roneil', 'roneilbansas5222@gmail.com', 'r'),
(45, 'p', 'p', 'p'),
(46, 'c', 'c', 'c'),
(47, 'h', 'h', 'h'),
(48, 'f', 'f', 'f'),
...
--
ALTER TABLE `tblmyclass`
  MODIFY `myclassId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT for table `tblmylessons`
--
ALTER TABLE `tblmylessons`
  MODIFY `myLessons_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1078;
...
--
ALTER TABLE `tblquizzes`
  MODIFY `quizzes_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `tblresult`
--
ALTER TABLE `tblresult`
  MODIFY `result_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
...
--
ALTER TABLE `tblstudent`
  MODIFY `student_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `tblstudentlang`
--
ALTER TABLE `tblstudentlang`
  MODIFY `class_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `tblsublessons`
--
ALTER TABLE `tblsublessons`
  MODIFY `sublesson_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
