...
(157, 'Video', 'unlock', 17, '1.1'),
(158, 'Texts', 'lock', 17, '1.2'),
(159, 'video', 'lock', 17, '1.3'),
(162, 'Quiz', 'unlock', 17, '1.7'),
...
(1240, 39, 168, 'lock', 18),
(1241, 39, 169, 'lock', 18),
(1242, 39, 170, 'unlock', 18),
(1243, 39, 171, 'unlock', 19),
(1244, 39, 172, 'lock', 19),
(1245, 39, 173, 'lock', 19),
(1246, 39, 174, 'lock', 19),
(1247, 39, 175, 'lock', 19),
(1248, 39, 176, 'unlock', 19),
(1249, 39, 177, 'unlock', 20),
(1250, 39, 178, 'lock', 20),
(1251, 39, 179, 'lock', 20),
(1252, 39, 180, 'lock', 20),
(1253, 39, 181, 'lock', 20),
(1254, 39, 182, 'lock', 20),
(1255, 39, 183, 'unlock', 20),
(1256, 39, 184, 'unlock', 21),
(1257, 39, 185, 'lock', 21),
(1258, 39, 186, 'lock', 21),
(1259, 39, 187, 'lock', 21),
(1260, 39, 188, 'lock', 21),
...
(1263, 39, 191, 'lock', 21),
(1264, 39, 192, 'lock', 21),
(1265, 39, 193, 'unlock', 21),
(1266, 39, 194, 'unlock', 22),
(1267, 39, 195, 'lock', 22),
(1268, 39, 196, 'lock', 22),
(1269, 39, 197, 'lock', 22),
(1270, 39, 198, 'lock', 22),
(1271, 39, 199, 'lock', 22),
(1272, 39, 200, 'lock', 22),
(1273, 40, 157, 'unlock', 17),
(1274, 40, 158, 'lock', 17),
(1275, 40, 159, 'lock', 17),
(1279, 40, 162, 'lock', 17),
(1280, 40, 163, 'unlock', 18),
(1281, 40, 164, 'lock', 18),
(1282, 40, 165, 'lock', 18),
(1283, 40, 166, 'lock', 18),
(1284, 40, 167, 'lock', 18),
(1285, 40, 168, 'lock', 18),
(1286, 40, 169, 'lock', 18),
(1287, 40, 170, 'unlock', 18),
(1288, 40, 171, 'unlock', 19),
(1289, 40, 172, 'lock', 19),
(1290, 40, 173, 'lock', 19),
(1291, 40, 174, 'lock', 19),
(1292, 40, 175, 'lock', 19),
(1293, 40, 176, 'unlock', 19),
(1294, 40, 177, 'unlock', 20),
(1295, 40, 178, 'lock', 20),
(1296, 40, 179, 'lock', 20),
(1297, 40, 180, 'lock', 20),
(1298, 40, 181, 'lock', 20),
(1299, 40, 182, 'lock', 20),
(1300, 40, 183, 'unlock', 20),
(1301, 40, 184, 'unlock', 21),
(1302, 40, 185, 'lock', 21),
(1303, 40, 186, 'lock', 21),
(1304, 40, 187, 'lock', 21),
(1305, 40, 188, 'lock', 21),
...
(1308, 40, 191, 'lock', 21),
(1309, 40, 192, 'lock', 21),
(1310, 40, 193, 'unlock', 21),
(1311, 40, 194, 'unlock', 22),
(1312, 40, 195, 'lock', 22),
(1313, 40, 196, 'lock', 22),
(1314, 40, 197, 'lock', 22),
(1315, 40, 198, 'lock', 22),
...
(1317, 40, 200, 'lock', 22),
(1318, 41, 157, 'done', 17),
(1319, 41, 158, 'unlock', 17),
(1320, 41, 159, 'lock', 17),
(1323, 41, 162, 'done', 17),
(1324, 41, 163, 'unlock', 18),
(1325, 41, 164, 'lock', 18),
(1326, 41, 165, 'lock', 18),
(1327, 41, 166, 'lock', 18),
(1328, 41, 167, 'lock', 18),
(1329, 41, 168, 'lock', 18),
(1330, 41, 169, 'lock', 18),
(1331, 41, 170, 'unlock', 18),
(1332, 41, 171, 'unlock', 19),
(1333, 41, 172, 'lock', 19),
(1334, 41, 173, 'lock', 19),
(1335, 41, 174, 'lock', 19),
(1336, 41, 175, 'lock', 19),
(1337, 41, 176, 'unlock', 19),
(1338, 41, 177, 'unlock', 20),
(1339, 41, 178, 'lock', 20),
(1340, 41, 179, 'lock', 20),
(1341, 41, 180, 'lock', 20),
(1342, 41, 181, 'lock', 20),
(1343, 41, 182, 'lock', 20),
(1344, 41, 183, 'unlock', 20),
(1345, 41, 184, 'unlock', 21),
(1346, 41, 185, 'lock', 21),
(1347, 41, 186, 'lock', 21),
(1348, 41, 187, 'lock', 21),
(1349, 41, 188, 'lock', 21),
...
(1352, 41, 191, 'lock', 21),
(1353, 41, 192, 'lock', 21),
(1354, 41, 193, 'unlock', 21),
(1355, 41, 194, 'unlock', 22),
(1356, 41, 195, 'lock', 22),
(1357, 41, 196, 'lock', 22),
(1358, 41, 197, 'lock', 22),
(1359, 41, 198, 'lock', 22),
...
(172, 'What is Programming?', 'Programming is when you give instructions for a computer to follow.\r\nWithout programs, computers are not very smart.\r\n', '', '', 158),
(174, ' To truly take an interest in\r\nlearning programming knowledge\r\nYou need to develop a liking for it.\r\n\r\nProgramming demands intense concentration.\r\ncommitment to learning,  so youll\r\nneed to find something about it\r\nthat seriously appeals to you. ', '', '', 'whatisacomputer_desktop_computers.jpg', 158),
(175, 'Developing a strong mindset is\r\nnecessary to learning any skill.\r\nOnce youve established the why,\r\ntake the time to focus on the how.\r\nTry asking yourself:\r\n\r\nOkay, I am willing to learn this,\r\nnow, how will I go about it?', '', '', 'question.png', 158),
(176, '', '', 'Intro-Java.mp4', '', 159);
...
--
ALTER TABLE `tblmyclass`
  MODIFY `myclassId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;

--
-- AUTO_INCREMENT for table `tblmylessons`
--
ALTER TABLE `tblmylessons`
  MODIFY `myLessons_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1362;
...
--
ALTER TABLE `tblquizzes`
  MODIFY `quizzes_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `tblresult`
--
ALTER TABLE `tblresult`
  MODIFY `result_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
...
--
ALTER TABLE `tblstudent`
  MODIFY `student_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `tblstudentlang`
--
ALTER TABLE `tblstudentlang`
  MODIFY `class_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `tblsublessons`
--
ALTER TABLE `tblsublessons`
  MODIFY `sublesson_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
