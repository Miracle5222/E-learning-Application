...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2023 at 12:43 AM
...
(370, 'False', 'nextInt', 100),
(371, 'True', 'Scanner', 100),
(372, 'False', 'nextLine', 100),
(373, 'True', 'nextInt()', 99),
(374, 'False', 'input()', 99),
(375, 'False', 'nextLine()', 99);
...
(44, 'Data Types and Arithmetic', 1, 'lock'),
...
(2115, 70, 251, 'done', 47),
(2116, 70, 252, 'done', 47),
(2117, 70, 253, 'unlock', 48),
(2118, 70, 254, 'lock', 48),
(2119, 70, 255, 'lock', 48),
(2120, 70, 256, 'lock', 48),
(2121, 70, 257, 'lock', 48),
(2122, 71, 219, 'done', 17),
(2123, 71, 220, 'unlock', 17),
(2124, 71, 221, 'lock', 17),
(2125, 71, 222, 'lock', 17),
(2126, 71, 223, 'lock', 17),
(2127, 71, 224, 'lock', 17),
...
(2129, 71, 226, 'lock', 17),
(2130, 71, 227, 'lock', 17),
(2131, 71, 228, 'unlock', 44),
(2132, 71, 229, 'lock', 44),
(2133, 71, 230, 'lock', 44),
(2134, 71, 231, 'lock', 44),
(2135, 71, 232, 'lock', 44),
(2136, 71, 235, 'unlock', 45),
(2137, 71, 236, 'lock', 45),
(2138, 71, 237, 'lock', 45),
(2139, 71, 238, 'lock', 45),
(2140, 71, 241, 'lock', 45),
(2141, 71, 242, 'unlock', 46),
(2142, 71, 243, 'lock', 46),
(2143, 71, 244, 'lock', 46),
(2144, 71, 245, 'lock', 46),
(2145, 71, 246, 'lock', 46),
(2146, 71, 247, 'lock', 46),
(2147, 71, 248, 'unlock', 47),
(2148, 71, 249, 'lock', 47),
(2149, 71, 250, 'lock', 47),
(2150, 71, 251, 'lock', 47),
(2151, 71, 252, 'lock', 47),
(2152, 71, 253, 'unlock', 48),
(2153, 71, 254, 'lock', 48),
(2154, 71, 255, 'lock', 48),
(2155, 71, 256, 'lock', 48),
(2156, 71, 257, 'lock', 48);
...
(99, 'Fill in the blank with the appropriate method call that reads an integer value entered by the user.\r\n\r\nScanner scanner = new Scanner(System.in);\r\nint value = scanner.________();\r\n', '35', 'Medium', 29, 'Multiple Choice'),
(100, 'Fill in the missing code in the following program to create an instance of the Scanner class that reads input from the user:\r\n\r\nScanner scanner = new _________(System.in);\r\n', '34', 'Medium', 29, 'Multiple Choice'),
...
(204, 27, 85, 'Passed', '01:44:16', 10),
(205, 28, 85, 'Passed', '01:45:24', 7),
(206, 29, 85, 'Passed', '01:46:56', 9),
(207, 30, 85, 'Passed', '01:48:06', 8),
(208, 31, 85, 'Passed', '01:49:50', 9),
(209, 29, 84, 'Failed', '10:39:00', 5),
(210, 29, 84, 'Failed', '10:40:07', 5),
(211, 29, 84, 'Failed', '10:40:47', 7),
(212, 29, 84, 'Passed', '11:30:45', 8),
(213, 29, 84, 'Passed', '11:32:43', 9);
...
(84, 'i', 'i', 'i'),
(85, 'o', 'o', 'o'),
(86, 'roneil', 'roneilbansas5222@gmail.com', 'bansas');
...
(251, 'Exercise:\r\n\r\nDeclare a variable called myInt and assign the value 10 to it. Then print out the value of myInt to the console. ', 'You can use either the code editor within the app or Eclipse to complete this exercise. ', '', '', 223),
(252, 'Solution:', 'Output:\r\n10', '', 's.png', 223),
(253, 'Exercise:\r\n\r\n\"Write a Java program to print \"Hello, World!\" to the console.\" ', 'You can use either the code editor within the app or Eclipse to complete this exercise.  ', '', '', 221),
(254, 'Solution', 'Output:\r\n\r\nHello, World!', '', 'javae.png', 221),
(255, 'Exercise : Fixing Syntax Errors\r\n\r\nThe following Java program contains syntax errors. Identify and fix the errors so that the program compiles and runs without errors. ', 'You can use either the code editor within the app or Eclipse to complete this exercise.  ', '', 'e.png', 225),
(256, 'Solution:\r\n\r\nThe program has no syntax errors.', '', '', '', 225),
(257, 'Exercise : Fixing Logical Errors\r\n\r\nThe following Java program contains a logical error. Identify and fix the error so that the program produces the correct output.', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 226),
(258, 'Solution:\r\n\r\nThe program calculates the product of x and y instead of their sum. To fix this error, change the operation to addition.', 'Output:\r\nThe sum of 5 and 7 is 12', '', 'er.png', 226),
(259, 'Exercise:\r\nDeclare and initialize variables with appropriate values for the following data types:\r\n\r\nint -->  representing the number of days in a week.\r\ndouble -->  representing the value of pi (π).\r\nboolean --> representing whether it is raining or not.\r\nchar --> representing your favorite letter.\r\n\r\nPrint out the values of these variables to the console. ', ' You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 229),
(260, 'Solution:', 'This program declares and initializes variables of int, double, boolean, and char data types, and then prints out their values to the console using the System.out.println() method. The output of this program should be:\r\n\r\n7\r\n3.14159\r\nfalse\r\nS', '', 'data.png', 229),
(261, 'Exercise:\r\n\r\nWrite a Java program that performs the following operations:\r\n\r\nDeclare two integer variables num1 and num2 and assign them the values 10 and 5, respectively.\r\n\r\nPrint the result of adding \"num1 and num2.\"\r\nPrint the result of subtracting \"num1 and num2\"\r\nPrint the result of multiplying \"num1 and num2\"\r\nPrint the result of dividing \"num1 and num2\"\r\nPrint the result of taking the remainder when num1 is divided by num2', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 230),
(262, 'Solution:\r\n', 'This program declares two integer variables num1 and num2, performs arithmetic operations on them using the +, -, *, /, and % operators, and then prints out the results to the console using the System.out.println() method. \r\nThe output of this program should be:\r\n\r\nnum1 + num2 = 15\r\nnum1 - num2 = 5\r\nnum1 * num2 = 50\r\nnum1 / num2 = 2\r\nnum1 % num2 = 0\r\n\r\nNote: that the parentheses around the arithmetic operations are necessary to ensure that the correct order of operations is followed.\r\n\r\n\r\n\r\n\r\n\r\n\r\n', '', 'ar.png', 230),
(263, 'Exercise:\r\n\r\nWrite a Java program that uses a \'for loop\' to add all the numbers between 1 and 10 (inclusive), and then displays the result. ', 'You can use either the code editor within the app or Eclipse to complete this exercise. ', '', '', 242),
(264, 'Solution  ', 'Output:\r\n\r\nThe sum of numbers from 1 to 10 is: 55 ', '', 'for.png', 242),
(265, 'Exercise:\r\n\r\nWrite a Java program that uses a while loop to add all the numbers between 1 and 10 (inclusive), and then displays the result.', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 244),
(266, 'Solution', 'Output:\r\nThe sum of numbers from 1 to 10 is: 55', '', 'w.png', 244),
(267, 'Exercise:\r\n\r\nWrite a Java program that generates a random integer between 1 and 100, and then checks if the number is even or odd. The program should display a message indicating the result.', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 235),
(268, 'Solution ', 'Sample Output:\r\n\r\n53 is odd. ', '', '', 235),
(269, 'Exercise:\r\n\r\nWrite a Java program that calculates the sum of two integers and displays the result using a method.', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 248),
(270, 'Solution', 'Output:\r\n\r\nThe sum of 5 and 7 is 12.', '', '', 248),
(271, 'Exercise:\r\n\r\nWrite a Java program that initializes an array of integers with the values 2, 4, 6, 8, 10, and displays the values using a loop.', 'You can use either the code editor within the app or Eclipse to complete this exercise.', '', '', 253),
(272, 'Solution:', 'Output:\r\nArray values:\r\nElement 0: 2\r\nElement 1: 4\r\nElement 2: 6\r\nElement 3: 8\r\nElement 4: 10', '', 'array.png', 253);
...
--
ALTER TABLE `tblchoices`
  MODIFY `choice_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;
...
--
ALTER TABLE `tblmyclass`
  MODIFY `myclassId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=426;

--
-- AUTO_INCREMENT for table `tblmylessons`
--
ALTER TABLE `tblmylessons`
  MODIFY `myLessons_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2157;
...
--
ALTER TABLE `tblquizzes`
  MODIFY `quizzes_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=228;

--
-- AUTO_INCREMENT for table `tblresult`
--
ALTER TABLE `tblresult`
  MODIFY `result_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=214;

--
-- AUTO_INCREMENT for table `tblsnippets`
--
ALTER TABLE `tblsnippets`
  MODIFY `snippets_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `tblstudent`
--
ALTER TABLE `tblstudent`
  MODIFY `student_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `tblstudentlang`
--
ALTER TABLE `tblstudentlang`
  MODIFY `class_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `tblsublessons`
--
ALTER TABLE `tblsublessons`
  MODIFY `sublesson_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;
